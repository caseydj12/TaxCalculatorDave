namespace TaxCalc.BusinessLogic
{
    public interface ITaxCalculatorBL
    {
        ...
        /// <returns>Annual Tax Paid</returns>
        ...
        /// </summary>
        /// <param name="grossAnnualIncome"></param>
        /// <returns>Monthly Gross Salary</returns>
        ...
        /// </summary>
        /// <param name="grossAnnualIncome"></param>
        /// <returns>Annual Net Salary</returns>
        ...
        /// </summary>
        /// <param name="grossAnnualIncome"></param>
        /// <returns>Monthly Net Salary</returns>
        ...
        /// </summary>
        /// <param name="grossAnnualIncome"></param>
        /// <returns>Monthly Tax Paid</returns>
